...
NormalPost::NormalPost(string _author, string _title, string _message, int _id, string _image_address)
{
    author = _author;
    title = _title;
    message = _message;
...
void NormalPost::show_course_post_overview(vector <string> &result)
{
    result.push_back(to_string(id));
    result.push_back(SPACE);
...
void NormalPost::show_course_post_details(vector <string> &result)
{
    result.push_back(to_string(id));
    result.push_back(SPACE);
    result.push_back(author);
